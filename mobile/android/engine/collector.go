...
// AUTOGENERATED BY ./mobile/android/build.bash; DO NOT EDIT
...
// GetLogs returns logs useful for debugging.
func (r *CollectorSubmitResults) GetLogs() string {
	return r.logs
}

// GetUpdatedReportID returns the updated report ID.
func (r *CollectorSubmitResults) GetUpdatedReportID() string {
	return r.updatedReportID
}

// GetUpdatedSerializedMeasurement returns the measurement with updated fields.
func (r *CollectorSubmitResults) GetUpdatedSerializedMeasurement() string {
